...
You need either a Ubuntu or Debian based system for qa.webtide.co.za, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/qa.webtide.co.za.yml` to the remote server with:
