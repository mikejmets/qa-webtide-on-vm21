...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-qa.webtide.on.vm21:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-qa.webtide.on.vm21:initial")
        transaction.commit()
    app._p_jar.sync()
