...
Install qa.webtide.on.vm21 with uv.

```shell
uv add qa.webtide.on.vm21
```
...
- [Issue tracker](https://github.com/mikejmets/qa-webtide-on-vm21/issues)
- [Source code](https://github.com/mikejmets/qa-webtide-on-vm21/)
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-05-15 08:59:20.. A special thanks to all contributors and supporters!
